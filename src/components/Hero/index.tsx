            ...
            <div className="w-full px-4">
              ...
              >
                <h1 className="mb-6 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]">
                  Transforma Tu Práctica de Cirugía Plástica con Nuestro SaaS Especializado
                </h1>
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                Nuestro software simplifica la gestión de pacientes, optimiza procesos y mejora resultados. Descubre la eficiencia y
                 el éxito con nuestra solución especializada.
                </p>
                ...
                <div>
                  <p className="mb-4 text-center text-base font-medium text-white/60">
                    Contacta con nosotros para saber mas sobre como podemos ayudarte con tu SaaS de cirugia
                  </p>
                  <div
